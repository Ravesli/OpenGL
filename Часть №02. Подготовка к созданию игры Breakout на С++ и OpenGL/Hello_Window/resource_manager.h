...
// Статический singleton-класс ResourceManager, 
// содержащий несколько функций для загрузки текстур и шейдеров. 
...
public:
    ...
    // Загружаем (и генерируем) из файла загрузки исходного кода вершинных, фрагментных (и геометрических) шейдеров. 
