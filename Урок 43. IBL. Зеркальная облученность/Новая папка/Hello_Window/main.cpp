...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // рендер scene, supplying the convoluted irradiance map to the final shader.
        // ------------------------------------------------------------------------------------------
        pbrShader.use();
        ...
        // рендер light source (simply re-render sphere at light positions)
        ...
        // рендер skybox (render as last to prevent overdraw)
        backgroundShader.use();
