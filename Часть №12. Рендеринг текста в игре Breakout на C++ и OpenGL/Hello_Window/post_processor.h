...
// Класс PostProcessor содержит все используемые в игре Breakout
// эффекты постобработки. Он производит рендеринг игры в текстурированный прямоугольник,
...
public:
    ...
    void EndRender();
    // рендерит текстуру объекта класса PostProcessor (в качестве большого, охватывающего экран, спрайта)
