...
private:
    ...
    // Рекурсивная обработка узла. Обрабатываем каждый отдельный меш, расположенный в узле, и повторяет этот процесс для дочерних узлов (если таковые вообще имеются)
